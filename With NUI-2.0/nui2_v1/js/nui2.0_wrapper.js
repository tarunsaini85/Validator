...
$n.fn.ajaxReq = $n.ajax;
$n.brewser = $n.browser;
$n.fn.currObj = function(){
	return this[0];
	
}
$n.fn.innerheight = $n.innerheight;
$n.fn.innerwidth = $n.innerwidth;
$n.fn.parents = function(){
	var that = this;
	var thatAll = []
		for(var i=0; i<that.length; i++){
			thatAll.push(that[i].parentNode);
...
el = $n;
$n.fn.childs = $n.fn.childrens = $n.fn.children;
...
$n.fn.ev=$n.ev;
$n.fn.getStyle = getStyle;
$n.fn.getCss = $n.fn.getCSS;