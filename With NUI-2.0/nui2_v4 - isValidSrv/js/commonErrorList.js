...
var commonErrList = {
	...
	2003 : function(){if($n('#opt1I')[0].selectedIndex==1){return 'Please select option other than this'}else{return false}},
	...
	2007 : function(){var rtn = false;if($n('#opt2I')[0].selectedIndex==1){rtn='Please select option other than this'}return {msg:rtn,id:'cstErrId'}},
	2008 : myFunc1,
