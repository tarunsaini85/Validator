...
var commonErrList = {
	...
	2003 : function(){if($('#opt1I').get(0).selectedIndex==1){return 'Please select option other than this'}else{return false}},
	...
	//2006 : function(){if($('#opt2I').get(0).selectedIndex==1){return 'Please select option other than this','cstErrId'}else{return false}},
	2007 : function(){var rtn = false;if($('#opt2I').get(0).selectedIndex==1){rtn='Please select option other than this'}return {msg:rtn,id:'cstErrId'}},
	2008 : myFunc1,
	2010 : {regEx:/^[a-zA-Z\d\s]+$/},
	2011 : function(obj){var o=obj.get(0).options,sOpt=[];for(var x=0;x<o.length;x++){if(o[x].selected){sOpt.push(o[x].value)}}if(sOpt.length>2){return 'Maximum 2 options are allowed'}else{return false}},
