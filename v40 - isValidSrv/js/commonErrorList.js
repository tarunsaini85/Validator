...
var commonErrList = {
	...
	2011 : function(obj){var o=obj.currObj().options,sOpt=[];for(var x=0;x<o.length;x++){if(o[x].selected){sOpt.push(o[x].value)}}if(sOpt.length>2){return 'Maximum 2 options are allowed'}else{return false}},
